...
//		setDefendHeight(Constants.PLAYER_DEFAULT_DEFEND_H);		
		setAttackNearName(Constants.PURPLEBABY_ATTACKNEAR_NAME);
		setAttackFarName(Constants.PURPLEBABY_ATTACKFAR_NAME);
		setAttackKillName(Constants.PURPLEBABY_ATTACKKILL_NAME);
		setDefendName(Constants.PURPLEBABY_DEFEND_NAME);
	}
