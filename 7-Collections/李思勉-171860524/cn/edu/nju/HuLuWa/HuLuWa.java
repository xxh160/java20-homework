...
public class HuLuWa extends Creature{
    ...
    public void walkTo(BattleField battleField,int row,int column){
    ...
    public static void sortInRow(BattleField battleField,int row,boolean reverse){
    ...
    public static void shuffleInRow(BattleField battleField,int row){
    ...
    public static void arrangeInRows(BattleField battleField, int row1,int row2,int arrangeMode){
        ArrayList<HuLuWa> list1 = new ArrayList<HuLuWa>();
        ArrayList<HuLuWa> list2 = new ArrayList<HuLuWa>();
        for(HuLuWa huLuWa:huLuWaList){
            if(huLuWa.gender==0){
                list1.add(huLuWa);
            }
