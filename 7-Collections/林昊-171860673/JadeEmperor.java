...
//            calabashKidArray.add(new CalabashKid(i, "老" + i, Enums.random(Gender.class))); // just for debug
            calabashKidArray.add(new CalabashKid(i, getFamilyName() + getGivenName(), Enums.random(Gender.class)));
        }
    }
    ...
    public static class CalabashKidArrayList<E extends CalabashKid> extends ArrayList<CalabashKid> {
        public static void sortByComparable(CalabashKidArrayList<CalabashKid> array, Order order){
            for(CalabashKid calabashKid : array){
                calabashKid.setOrder(order);
            }
            Sort.insertionSort(array);
        }

        public static void sortByComparator(ArrayList<CalabashKid> array, Order order){
            for(CalabashKid calabashKid : array){
                calabashKid.setOrder(order);
            }
    ...
    // 玉皇大帝有打印葫芦娃名单的能力
    private static void print(ArrayList<CalabashKid> array) {
        for (Human curHuman : array) {
            System.out.print(curHuman.toString() + " ");
        }
        System.out.println();
    }

    private static void print(ArrayList<CalabashKid> array, Gender gender){
        System.out.print(gender + ": ");
        print(array);
    }

    private static void print(String msg, ArrayList<CalabashKid> array, Gender gender) {
        System.out.println(msg);
        print(array, gender);
    }

    private static void print(String msg, ArrayList<CalabashKid> array){
        System.out.println(msg);
        print(array);
    }
