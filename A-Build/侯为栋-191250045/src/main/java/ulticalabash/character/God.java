...
public abstract class God<T extends Creature> implements Comparator<T> {
    ...
    public String callChildren(ArrayList<T> children) {
        StringBuilder builder = new StringBuilder();
    ...
    public Comparator<T> buildComparator() {
        return switch (this.flag) {
            ...
            case SEX -> ((o1, o2) -> {
                ...
                if (res == 0) return Comparators.dict(o1.getName(), o2.getName());
                return res;
            });
    ...
    public abstract Pair<ArrayList<T>, ArrayList<T>> classify();

    public abstract Triple<ArrayList<Calabash>, ArrayList<Calabash>, ArrayList<Calabash>> classify(CompareFlag flag, String edge);
