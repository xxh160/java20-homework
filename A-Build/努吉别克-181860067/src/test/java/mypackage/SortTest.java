...
public class SortTest {
    Family<Calabash> new_family = new Family<Calabash>();
    Ordering<ArrayList<String>> my_order;
    ...
    public void test1() throws Exception {
        ...
        boolean order = Ordering.natural().isOrdered(new_family.get_name_list());
        assertFalse("测试失败", order == false);
