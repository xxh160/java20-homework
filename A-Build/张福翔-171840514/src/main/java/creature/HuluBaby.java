...
public class HuluBaby extends Creature {
    ...
    @Override
    public String toString() {
        return MoreObjects.toStringHelper(this).add("id", id).add("name", name).add("gender", gender).toString();
    }
    ...
    public int compareTo(Creature o) {
        if (this.getClass().equals(o.getClass())) {
            ...
            if (comparationType.equals(ComparationType.BYNAME)) {
                ...
                return ComparisonChain.start().compare(this.gender, obj.gender).compare(this.name, obj.name).result();
            }
        }
        else {
