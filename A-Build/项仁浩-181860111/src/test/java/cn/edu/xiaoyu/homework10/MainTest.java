...
public class MainTest {
    ...
    @Test
    public void test1(){
        Main<Calabash> calabashMain = new Main<Calabash>();
    ...
    @Test
    public void test2(){
        Main<CalabashFire> calabashFireMain=new Main<CalabashFire>();
    ...
    @Test
    public void test3(){
        Main<CalabashWater> calabashWaterMain = new Main<CalabashWater>();
