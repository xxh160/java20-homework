...
import mylib.CalaBro;
import sort.CalaAllSort;
import sort.CalaSexSort;
import sort.MySort;
...
public class CalaBroSortTest {
    ...
    public void testSort() throws Exception {
        ...
        maleList = Lists.newArrayList(Collections2.filter(list, x->x.getSex().equals("Male")));
        femaleList = Lists.newArrayList(Collections2.filter(list, x->x.getSex().equals("Female")));
