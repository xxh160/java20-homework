...
public class Sort {
    ...
    public static void sortbyway(List<Hulu> ranks, int way) throws Exception{
        ...
        {
            Collections.sort(ranks, new Ordering<Hulu>() {
                @Override
                public int compare(Hulu o1, Hulu o2) {
                    if(Hulu.sortway==0||Hulu.sortway==2)
                        return o1.getName().compareTo(o2.getName());
                    else if(Hulu.sortway==1)
                        return -o1.getName().compareTo(o2.getName());
                    else
                    {
                        try {
    ...
    public static void hulusort(int num) {
        ...
        malehulu = Lists.newArrayList();
        femalehulu = Lists.newArrayList();
